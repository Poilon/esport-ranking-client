      ...
      <v-row no-gutters>
        ...
        <v-col sm4 cols12>
          <a href="https://smash.gg/same-finale-2021" target="_blank">
            ...
            <v-img src="../assets/tournaments/10_SAMEcal_nov_finale_sticker.png" style="width: 100%; height: 250px; max-height: 270px; max-width: 300px; margin-left: auto; margin-right: auto; margin-top: -250px;" />
          </a>
        </v-col>
