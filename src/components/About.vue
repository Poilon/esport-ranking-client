<template>
  <v-container :style='background + "width: 100%; max-width: 100%; height: 100vh"'>
    <v-container style='background-color: white; opacity: 0.8;'>
      ...
      <p><b>Tune in this weekend to 🔥Smash Sauna Online🔥! on <a target="_blank" href="https://www.twitch.tv/btssmash/squad>btssmash/squad</a></b></p> and help raise funds for Finnish children's hospitals
      <p>SmashFinland will is heating up the competition with Melee Singles, Teams, Ladder and Smash Sisters and R5 of international crews!</p>

      <p><b>Registration is live for the next S.A.M.E event, Fête Online!</b></p>
      <p>TeamFête is hosting a week long party in their Minecraft venue from the <b>21st-27th of June</b> with Melee Singles, Teams, R5 of international crews, an Iron man bracket and much more to be revealed!</p>
