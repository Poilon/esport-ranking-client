<template>
  <v-container :style='background + "width: 100%; max-width: 100%; height: 100vh"'>
    <v-container style='background-color: white; opacity: 0.8;'>
      ...
      <p>Tune in this weekend to 🔥Smash Sauna Online🔥! on <a target="_blank" href="https://www.twitch.tv/btssmash/squad>btssmash/squad"</a></b></p> and help raise funds for Finnish children's hospitals
